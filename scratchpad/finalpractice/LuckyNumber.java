...
class SliderPanel extends HBox implements Observer
{
	...
	{
		aSlider.setValue(pModel.getNumber());
	}
...
class IntegerPanel extends HBox implements Observer
{
	...
	public void newNumber(Model pModel)
	{
		aText.setText(new Integer(pModel.getNumber()).toString());
	}
}
...
class TextPanel extends HBox implements Observer
{
	...
	public void newNumber(Model pModel)
	{
		aText.setText(LABELS[pModel.getNumber()]);
...
/**
 * Concrete observer that displays the model data
 * as a written-out Roman numeral in a text field.
 */
